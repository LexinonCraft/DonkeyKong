...
The project can be built with either CMake or Make. On JupyterHub, only Make works. Also, please note that the game runs significantly slower on JupyterHub than on your local machine to make the game playable despite the increased latency.
