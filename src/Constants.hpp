...
namespace constants {
    ...
    constexpr float BARREL_SPAWN_INTERVAL = 2.f;
    constexpr float BARREL_MIN_SPAWN_INTERVAL = 97.f / static_cast<float>(FRAME_RATE);
    constexpr unsigned int BARREL_MAX_ACTIVE_COUNT = 10;
