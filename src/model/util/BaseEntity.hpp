...
public:
     ...
     * @returns The entity's reference object.
     */
     ...
     * @returns True if the entity is pending destruction.
     */
     ...
     * @returns true if the pointer was reset because the entity was destroyed.
     ...
     * @returns Unique pointer to a climbable component or nullptr.
     */
     ...
     * @returns Unique pointer to a platform component or nullptr.
     */
     ...
     * @returns Unique pointer to an updatable component or nullptr.
     */
     ...
     * @returns Unique pointer to an enemy component or nullptr.
     */
     ...
     * @returns Unique pointer to a jumpable component or nullptr.
     */
     ...
     * @returns Unique pointer to a pickable component or nullptr.
     */
